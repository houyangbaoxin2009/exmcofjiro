...
execute unless score $bs.view.minor load.status matches 0 run return 0
execute unless score $bs.view.patch load.status matches 1 run return 0
...
function bs.load:v4.0.1/bundle/append {module:"bs.view"}
