...
execute unless data storage bs:const log.messages[{namespaces:["bs.sidebar"]}] run \
  data modify storage bs:const log.messages[{namespaces:["bs"]}].namespaces append value "bs.sidebar"
